export default {
  ...
  experience: {
    ...
    entries: {
      pfe: {
        ...
        projectTitle: 'Profilage et segmentation des stations',
  ...
  projectDetail: {
    ...
    floatingBackAria: 'Retour aux projets',
  ...
  about: {
    ...
    bio: [
      ...
      "En dehors du travail je lis — Dostoïevski, Plath, et tout ce que je peux trouver en trois langues — et j'écris de la fiction et des fragments, mal et régulièrement. Je pense en anglais, je discute en français, et je jure en darija. Les mathématiques sont venues en premier et le restent. La prépa a été la dernière fois que quelque chose a retenu mon attention comme le fait une démonstration, et l'essentiel de ce que j'ai appris depuis, je l'ai appris de la même façon : seul et la nuit, parce que j'en avais envie.",
    ],
